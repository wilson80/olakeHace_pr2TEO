        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="login-container">
                    ...
                    <form hr class="login-form" action="?c=login" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="password" name="password" placeholder="Escriba su constrasena" required>
                        </div>
                        <div class="mb-3">
